...
$uzrok_stete = $niz_podataka_knjigas['uzrokstete'];  
// Marko Markovic pocetak
// $conn_stete = pg_connect("host=localhost  dbname=stete user=zoranp");
$upit_uzrok_poz = "SELECT uzrok_id FROM predmet_odstetnog_zahteva 
					where id =  $id_stete";
...
if ($_GET['probni'] == 'DA') 
{
	...
	$opis_uzroka_stete = strtoupper($_GET['uzrok_nezgode']);
...
$nezgoda_podaci_ispis = $datum_nastanka_prikaz."godine,  ".$mesto_nastanka.$opis_uzroka_stete;    // Marko Markovic
...
// $pdf_zapisnik->Rect(10, 56, 90, 8);
// $pdf_zapisnik->Rect(10, 56, 140, 8);
$pdf_zapisnik->SetXY(10, 56);
$pdf_zapisnik->Cell(40, 8, "",1);
$pdf_zapisnik->SetXY(50, 56);
$pdf_zapisnik->Cell(50, 8, "",1);
$pdf_zapisnik->SetXY(100, 56);
$pdf_zapisnik->Cell(50, 8, "",1);
$pdf_zapisnik->SetXY(150, 56);
$pdf_zapisnik->Cell(50, 8, "",1);
$pdf_zapisnik->SetXY(10, 56);
$pdf_zapisnik->Cell(190, 4, mb_convert_encoding("Te¾ina: ", 'UTF-8', 'ISO-8859-2'),0);
$pdf_zapisnik->SetFont($font_name, 'B', 7);
$pdf_zapisnik->SetXY(30, 56);
