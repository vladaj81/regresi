...
$opis_rizika = mb_convert_encoding(strtoupper($podaci_rizik_uzrok['opis_rizika']), "UTF-8", "ISO-8859-2");
$opis_uzroka_stete = mb_convert_encoding(strtoupper($podaci_rizik_uzrok['opis_uzroka']), "UTF-8", "ISO-8859-2");	
...
if ($_GET['probni'] == 'DA') 
{
	...
	$opis_rizika = strtoupper($_GET['prijavljeni_rizik']);
...
$pdf_zapisnik->Cell(50, 4, mb_convert_encoding($opis_rizika, 'UTF-8', 'ISO-8859-2'), 0, 0, 'L', false, '', 1); 
...
$pdf_zapisnik->Cell(33, 4, mb_convert_encoding($opis_uzroka_stete, 'UTF-8', 'ISO-8859-2'), 0, 0, 'L', false, '', 1); 
//NOVI RED - KRAJ
